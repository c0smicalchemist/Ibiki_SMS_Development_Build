...
export default function SendSMS() {
  ...
  const generateVariants = async (base: string) => {
    ...
    try {
      ...
      if (p && p !== 'openrouter') {
        toast({ title: 'Using fallback', description: `Variants generated by ${p}. Configure OpenRouter key and select a model like qwen/qwen3-coder:free or alibaba/tongyi-deepresearch-30b-a3b:free.`, variant: 'destructive' });
      }
    } catch (e:any) {
      setVariants([]);
