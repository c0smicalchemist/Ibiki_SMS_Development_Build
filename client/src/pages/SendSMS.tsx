...
export default function SendSMS() {
  ...
  const generateVariants = async (base: string) => {
    ...
    try {
      ...
      setVariants((r?.variants || []).slice(0, 25));
      const p = String(r?.providerUsed || '');
      if (p && p !== 'openrouter') {
        toast({ title: 'Using fallback', description: `Variants generated by ${p}. Configure OpenRouter key and model for Grok.`, variant: 'destructive' });
      }
    } catch (e:any) {
      setVariants([]);
